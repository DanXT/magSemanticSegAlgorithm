classdef ResNNrk4 < abstractMegaNetElement
    ...
    %
    %  The time points for the states and controls can be spaces
    %  non-uniformaly and are described by the nodes of the 1D grids ttheta
    %  and tY.
    
    properties
        layer        % model for the layer (i.e., the nonlinearity)
        ttheta       % time points for controls
        tY           % time points for states
    ...
    methods
        function this = ResNNrk4(layer,ttheta,tY,varargin)
