...
%
% With a 2-2-2 architecture and widths of 16,32,64,64 this code achieves a
% test accuracy of around 71% (no data augmentation used).
% =========================================================================
...
resFile = sprintf('%s-nex-%d-nf-%d-%d-nt-%d',mfilename,nex,nfin,nfout,nt);
doTrain = true;
